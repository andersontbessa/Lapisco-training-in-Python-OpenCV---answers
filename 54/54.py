#método de classificação k-médias (K-means em inglês) --> vai marcar os centróides e achar os números de "k". Vai calcular a distância de cada ponto tendo em vista cada ponto dos centroides marcados. Por exemplo, um ponto pode calcular a distância entre três pontos centroides. Daí ele acha o centroide de menor distância e esse elemento se torna da mesma classe dele.
