...
def get_centroid(image): #centraliza algo no meio da imagem.
...
if __name__ == '__main__':
    ...
    new_img[np.where(segmented_image == 255)] = [255, 0, 0] #passando para fica azul

    # Draw a circle in the centroid of the segmented region
    cv2.circle(new_img, (yc, xc), 5, (0, 255, 0), -1) #é o círculo verde que vai fazer dentro da imagem segmentada.
