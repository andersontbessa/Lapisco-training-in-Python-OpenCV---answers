...
result = cv2.drawMatches(image, keypoints_1, logo, keypoints_2, matches[:2], None, flags=2)  #flags=2 -->pega alguns pontos da imagem
                                                                                                #o matches[:2] faz várias outras linhas em outros pontos.
# Show the result
