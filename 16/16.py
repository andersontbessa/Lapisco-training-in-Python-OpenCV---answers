...
#É uma representação gráfica da distribuição da intensidade de uma imagem.
#Ele quantifica o número de pixels para cada valor de intensidade considerado.

#O que é equalização de histograma? --->
#É um método que melhora o contraste em uma imagem, a fim de esticar a faixa de intensidade
