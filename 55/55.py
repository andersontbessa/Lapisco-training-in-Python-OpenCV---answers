...
#é uma rede neural com uma ou mais camadas ocultas com um número indeterminado de neurônios. A camada oculta possui esse nome porque não e possível prever a saída desejada nas camadas intermediárias.
#Rede neural --> É uma técnica que tem origem na psicologia e na neurobiologia. Consiste basicamente em simular o comportamento dos neurônios.
#camada de entreda - camada oculta - camada de saída
import cv2
import numpy as np
import math
import pandas as pd
